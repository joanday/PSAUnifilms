...
class AgreementScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // ✅ CHANGED: same fix as login_screen.dart / signup_screen.dart --
    // this screen's text and its full-width Agree/Decline buttons used to
    // stretch edge-to-edge on a wide/desktop browser window. Nothing about
    // the text or buttons changed -- this just caps the whole screen's
    // width at 480px and centers it on a wide/desktop screen. An actual
